  ...
  describe('DOMインターフェース編', function() {
    ...
    it('3 番の要素の左右の幽霊要素をすべて除去する', function() {
      ...
      while (document.querySelector('.mediumseagreen-ghosts')) {
          element.removeChild(document.querySelector('.mediumseagreen-ghosts'));
      }
    ...
    it('5 番の青色の要素の最初に要素を追加する', function() {
      ...
      // ここに記述してください。
      var referenceElement = document.querySelector('blockquote');
      var parentElement = referenceElement.parentNode;
      parentElement.insertBefore(elementToAdd, referenceElement);
